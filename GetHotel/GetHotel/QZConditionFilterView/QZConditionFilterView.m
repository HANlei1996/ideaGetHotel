...
{
    QZConditionFilterView *conditionFilter = [[QZConditionFilterView alloc] initWithFrame:CGRectMake(160, 220, SCREEN_WIDTH, 40)];
...
- (void)createSubView
{
    ...
    _dataSource1Btn = [self buttonWithLeftTitle:@"" titleColor:[UIColor lightGrayColor] Font:[UIFont systemFontOfSize:4] backgroundColor:[UIColor whiteColor] RightImageName:@"PR_filter_choice" Frame:CGRectMake(140,0, -150, 30)];
    [_dataSource1Btn setTitleColor:UIColorFromRGB(0x00a0ff) forState:UIControlStateSelected];
    [_dataSource1Btn setImage:[UIImage imageNamed:@""] forState:UIControlStateSelected];
    ...
    _dataSource2Btn = [self buttonWithLeftTitle:@"" titleColor:[UIColor lightGrayColor] Font:[UIFont systemFontOfSize:10] backgroundColor:[UIColor whiteColor] RightImageName:@"" Frame:CGRectMake(_dataSource1Btn.x+_dataSource1Btn.width+0.5, 0, -45, 30)];
    [_dataSource2Btn setTitleColor:UIColorFromRGB(0x00a0ff) forState:UIControlStateSelected];
    [_dataSource2Btn setImage:[UIImage imageNamed:@""] forState:UIControlStateSelected];
  ...
  /*  _dataSource3Btn = [self buttonWithLeftTitle:@"" titleColor:[UIColor whiteColor] Font:[UIFont systemFontOfSize:13] backgroundColor:[UIColor colorWithRed:20/255.0 green:140/255.0 blue:255.0 alpha:1.0] RightImageName:@"" Frame:CGRectMake(_dataSource2Btn.x+_dataSource2Btn.width+0.5, 0, (SCREEN_WIDTH-1)/3, 40)];
    [_dataSource3Btn setTitleColor:UIColorFromRGB(0x00a0ff) forState:UIControlStateSelected];
    [_dataSource3Btn setImage:[UIImage imageNamed:@""] forState:UIControlStateSelected];
...
-(UIButton *)buttonWithLeftTitle:(NSString *)title titleColor:(UIColor *)titleColor Font:(UIFont *)font backgroundColor:(UIColor *)backgroundColor RightImageName:(NSString *)imageName Frame:(CGRect)frame
{
    ...
    titleColor=titleColor?:[UIColor whiteColor];
...
{
    if (firstAry != nil) {
        [self changeBtn:_dataSource1Btn Text:[NSString stringWithFormat:@"%@",firstAry.firstObject] Font:[UIFont systemFontOfSize:10] ImageName:@""];
        _dataSource1 = firstAry;
    }
    if (secondAry != nil) {
        [self changeBtn:_dataSource2Btn Text:[NSString stringWithFormat:@"%@",secondAry.firstObject] Font:[UIFont systemFontOfSize:10] ImageName:@""];
        _dataSource2 = secondAry;
    }
    
    if (thirdAry != nil) {
        [self changeBtn:_dataSource3Btn Text:[NSString stringWithFormat:@"%@",thirdAry.firstObject] Font:[UIFont systemFontOfSize:10] ImageName:@""];
...
-(void)choseSort:(NSArray *)sortAry
{
    if (_dataSource1Btn.selected) {
        // 改变btn显示的数据
        [self changeBtn:_dataSource1Btn Text:[NSString stringWithFormat:@"%@",sortAry.firstObject] Font:[UIFont systemFontOfSize:13] ImageName:@""];
        // 存储显示的数据
        _dataSource1 = sortAry;
    }else if (_dataSource2Btn.selected){
        [self changeBtn:_dataSource2Btn Text:[NSString stringWithFormat:@"%@",sortAry.firstObject] Font:[UIFont systemFontOfSize:13] ImageName:@""];
        _dataSource2 = sortAry;
    }else if (_dataSource3Btn.selected){
        [self changeBtn:_dataSource3Btn Text:[NSString stringWithFormat:@"%@",sortAry.firstObject] Font:[UIFont systemFontOfSize:13] ImageName:@""];
...
-(void)changeTitleWithData1:(NSArray *)dataAry1 Data2:(NSArray *)dataAry2 Data3:(NSArray *)dataAry3
{
    ...
    [self changeBtn:_dataSource1Btn Text:data1Str Font:[UIFont systemFontOfSize:13] ImageName:@""];
   [self changeBtn:_dataSource2Btn Text:data2Str Font:[UIFont systemFontOfSize:13] ImageName:@""];
    [self changeBtn:_dataSource3Btn Text:data3Str Font:[UIFont systemFontOfSize:13] ImageName:@""];
